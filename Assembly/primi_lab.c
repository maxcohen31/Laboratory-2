/*
    Questo programma è preso dal Github di laboratorio 2 
*/
...
// programma già visto per la costruzione di una tabella di primi
// la differenza rispetto a prima e che la funzione primo()
// è scritta in assembler nel file primo.s

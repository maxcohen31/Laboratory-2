...
# di cifre assegnato da linea di comando (default 8)
...
def main(n,cifre):
  ...
  print("La cui somma è",somma_primi,file=sys.stderr)

if len(sys.argv)==2:
  main(int(sys.argv[1]), 8 )  # genera interi di 8 cifre di default
if len(sys.argv)!=3:
